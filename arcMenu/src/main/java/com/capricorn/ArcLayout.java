 ...
 * calling {@link #setArc(float, float,float) setArc()}. You can override the method
...
public class ArcLayout extends ViewGroup {
    ...
    private static int MIN_RADIUS = 200;
    ...
    public void setArc(float fromDegrees, float toDegrees,float minRadius) {
        if (mFromDegrees == fromDegrees && mToDegrees == toDegrees && MIN_RADIUS==minRadius) {
            return;
        }
