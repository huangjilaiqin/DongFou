...
public class ArcMenu extends RelativeLayout {
    ...
    private void applyAttrs(AttributeSet attrs) {
        if (attrs != null) {
            ...
            float minRadius = a.getDimensionPixelSize(R.styleable.ArcLayout_minRadius, 200);
            Log.e(TAG, "minRadius:"+minRadius);
            mArcLayout.setArc(fromDegrees, toDegrees,minRadius);
            ...
            Log.e(TAG, "newChildSize:"+newChildSize);
